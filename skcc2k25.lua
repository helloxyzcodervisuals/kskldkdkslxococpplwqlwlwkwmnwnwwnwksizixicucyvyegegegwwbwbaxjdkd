...
UI:CreateElement("toggle", section_visual, {name = "Hide Head", flag = "misc_hidehead", default = false, callback = function(value)
    if value then
        hideHead()
    else
        showHead()
...
UI:CreateElement("toggle", section_visual, {name = "Hands Up", flag = "misc_handsup", default = false, callback = function(value)
    if value then
        enableHandsUp()
    else
        disableHandsUp()
