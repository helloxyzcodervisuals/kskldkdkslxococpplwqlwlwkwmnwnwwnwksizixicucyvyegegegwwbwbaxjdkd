...
QuickUIFrame.Parent = game:GetService("CoreGui")
...
vizColumn1:Toggle({Name = "Enable ESP", Flag = "visualize_esp_enabled", callback = function(bool)
    getgenv().CONFIG.Visualize.ESP.Enabled = bool
end})

vizColumn1:ColorPicker({Name = "Box Color", Default = Color3.fromRGB(78, 150, 50), Flag = "visualize_boxcolor", callback = function(color)
    getgenv().CONFIG.Visualize.ESP.BoxColor = color
end})

vizColumn1:ColorPicker({Name = "Outline Color", Default = Color3.fromRGB(78, 150, 50), Flag = "visualize_outlinecolor", callback = function(color)
    getgenv().CONFIG.Visualize.ESP.OutlineColor = color
end})

vizColumn1:ColorPicker({Name = "Text Color", Default = Color3.fromRGB(255, 255, 255), Flag = "visualize_textcolor", callback = function(color)
    getgenv().CONFIG.Visualize.ESP.TextColor = color
end})

vizColumn1:Slider({Name = "Max Distance", Min = 100, Max = 5000, Default = 1000, Flag = "visualize_maxdistance", callback = function(value)
    getgenv().CONFIG.Visualize.ESP.MaxDistance = value
end})

vizColumn2:Toggle({Name = "Local Forcefield", Flag = "visualize_forcefield_enabled", callback = function(bool)
...
vizColumn2:Slider({Name = "Forcefield Transparency", Min = 0, Max = 1, Default = 0.5, Flag = "visualize_forcefield_transparency", callback = function(value)
...
vizColumn2:ColorPicker({Name = "Forcefield Color", Default = Color3.fromRGB(255, 255, 255), Flag = "visualize_forcefield_color", callback = function(color)
...
vizColumn6:Toggle({Name = "Arrow Indicators", Flag = "visualize_arrow_enabled", callback = function(bool)
    getgenv().CONFIG.Visualize.ArrowEnabled = bool
end})

vizColumn6:ColorPicker({Name = "Arrow Color", Default = Color3.fromRGB(255, 255, 255), Flag = "visualize_arrow_color", callback = function(color)
    getgenv().CONFIG.Visualize.ArrowColor = color
end})

vizColumn6:Slider({Name = "Arrow Distance", Min = 50, Max = 200, Default = 80, Flag = "visualize_arrow_distance", callback = function(value)
    getgenv().CONFIG.Visualize.ArrowDistance = value
end})

vizColumn6:Slider({Name = "Arrow Size", Min = 8, Max = 32, Default = 16, Flag = "visualize_arrow_size", callback = function(value)
    getgenv().CONFIG.Visualize.ArrowSize = value
end})

vizColumn6:Slider({Name = "Arrow Thickness", Min = 1, Max = 5, Default = 1, Flag = "visualize_arrow_thickness", callback = function(value)
    getgenv().CONFIG.Visualize.ArrowThickness = value
end})

vizColumn6:Toggle({Name = "Arrow Anti-Aliasing", Flag = "visualize_arrow_aa", callback = function(bool)
    getgenv().CONFIG.Visualize.ArrowAA = bool
end})
...
configColumn1:Button({Name = "Save Config", Callback = function()
    if writefile then
        ...
        writefile("skcc_config.json", game:GetService("HttpService"):JSONEncode(allConfigs))
...
configColumn1:Button({Name = "Load Config", Callback = function()
    if readfile and isfile and isfile("skcc_config.json") then
        local success, data = pcall(function()
            return game:GetService("HttpService"):JSONDecode(readfile("skcc_config.json"))
        end)
...
configColumn2:Button({Name = "Save as Preset", Callback = function()
    if writefile and getgenv().currentConfigName then
        ...
        if name ~= "" then
            ...
            writefile("skcc_preset_" .. name .. ".json", game:GetService("HttpService"):JSONEncode(allConfigs))
...
configColumn2:Button({Name = "Delete Preset", Callback = function()
    if delfile and getgenv().currentConfigName then
        local name = getgenv().currentConfigName
        if name ~= "" then
            local filename = "skcc_preset_" .. name .. ".json"
...
configColumn2:Button({Name = "Refresh Presets", Callback = function()
    if isfile then
        for _, file in pairs(listfiles("")) do
            if file:find("skcc_preset_") and file:find("%.json$") then
                local name = file:match("skcc_preset_(.+)%.json")
                configColumn2:Button({Name = name, Callback = function()
                    if readfile then
                        local success, data = pcall(function()
...
print("SKCC.LUA Loaded Successfully!")