    ...
    -- Misc functions
        ...
        function library:makeResizable(frame)
            ...
            local function getPos(input)
                return input.Position or UIS:GetMouseLocation()
            end
            ...
            UIS.InputChanged:Connect(function(input)
                ...
                or input.UserInputType == Enum.UserInputType.Touch then
                    ...
                    frame.Size = UDim2.fromOffset(
                        ...
                        math.max(150, startSize.Y.Offset + delta.Y)
                    )
                end
            end)
        end
            ...
            UIS.InputChanged:Connect(function(input)
                ...
                or input.UserInputType == Enum.UserInputType.Touch then
                    ...
                    frame.Position = UDim2.fromOffset(
                        math.clamp(startFramePos.X.Offset + delta.X, 0, cam.X - frame.AbsoluteSize.X),
                        math.clamp(startFramePos.Y.Offset + delta.Y, 0, cam.Y - frame.AbsoluteSize.Y)
                    )
                end
            end)
        end
