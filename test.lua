...
RagebotLeft:AddSlider('RagebotFireRate', {Text = 'Fire Rate', Min = 1, Max = 1000, Default = 30, Callback = function(v) Config.Ragebot.FireRate = v end})
RagebotLeft:AddSlider('RagebotWallbangRange', {Text = 'Wallbang Range', Min = 10, Max = 30, Default = 30, Callback = function(v) Config.Ragebot.WallbangRange = v end})
...
RagebotRight:AddSlider('RagebotFOV', {Text = 'FOV', Min = 10, Max = 360, Default = 120, Callback = function(v) Config.Ragebot.FOV = v end})
...
VisualsLeft:AddSlider('ESPMaxDistance', {Text = 'Max Distance', Min = 50, Max = 1000, Default = 500, Callback = function(v) Config.ESP.MaxDistance = v end})
...
VisualsRight:AddSlider('ESPBoxTransparency', {Text = 'Box Transparency', Min = 0, Max = 1, Default = 0.5, Callback = function(v) Config.ESP.BoxTransparency = v end})
VisualsRight:AddSlider('ESPArrowSize', {Text = 'Arrow Size', Min = 10, Max = 50, Default = 30, Callback = function(v) Config.ESP.ArrowSize = v end})
EffectsLeft:AddToggle('RagebotTracers', {Text = 'Tracers', Default = true, Callback = function(s) Config.Ragebot.Tracers = s end})
EffectsLeft:AddSlider('RagebotTracerWidth', {Text = 'Tracer Width', Min = 0.1, Max = 5, Default = 1, Callback = function(v) Config.Ragebot.TracerWidth = v end})
EffectsLeft:AddSlider('RagebotTracerLifetime', {Text = 'Tracer Lifetime', Min = 0.5, Max = 10, Default = 3, Callback = function(v) Config.Ragebot.TracerLifetime = v end})
...
CharacterVisuals:AddSlider('ForcefieldTransparency', {Text = 'FF Transparency', Min = 0, Max = 1, Default = 0.3, Callback = function(v) Config.VisualSettings.Forcefield.Transparency = v if Config.VisualSettings.Forcefield.Enabled then applyVisual("Forcefield") end end})
Notifications:AddToggle('RagebotHitNotify', {Text = 'Hit Notify', Default = true, Callback = function(s) Config.Ragebot.HitNotify = s end})
Notifications:AddSlider('RagebotHitNotifyDuration', {Text = 'Notify Duration', Min = 1, Max = 10, Default = 5, Callback = function(v) Config.Ragebot.HitNotifyDuration = v end})
...
MiscLeft:AddSlider('SpeedValue', {Text = 'Speed Value', Min = 10, Max = 200, Default = 50, Callback = function(v) Config.speedValue = v end})
...
MiscRight:AddSlider('JumpPowerValue', {Text = 'Jump Value', Min = 50, Max = 300, Default = 100, Callback = function(v) Config.JumpPowerValue = v end})
...
FlySection:AddSlider('FlySpeed', {Text = 'Fly Speed', Min = 10, Max = 200, Default = 50, Callback = function(v) Config.Fly.Speed = v if Config.Fly.SpeedDisplay then Config.Fly.SpeedDisplay.Text = tostring(v) end end})
...
ShaderSection:AddSlider('Brightness', {Text = 'Brightness', Min = -1, Max = 1, Default = 0, Callback = function(v) if Config.colorCorrection then Config.colorCorrection.Brightness = v end end})
ShaderSection:AddSlider('Contrast', {Text = 'Contrast', Min = -1, Max = 1, Default = 0, Callback = function(v) if Config.colorCorrection then Config.colorCorrection.Contrast = v end end})
ShaderSection:AddSlider('Saturation', {Text = 'Saturation', Min = -1, Max = 1, Default = 0, Callback = function(v) if Config.colorCorrection then Config.colorCorrection.Saturation = v end end})
...
LegitbotRight:AddSlider('LegitbotFOV', {Text = 'FOV', Min = 10, Max = 1000, Default = 120, Callback = function(v) Config.Legitbot.FOV = v Config.fovCircle.Radius = v end})
...
LegitVisualLeft:AddSlider('LegitbotTracerWidth', {Text = 'Tracer Width', Min = 0.1, Max = 5, Default = 1, Callback = function(v) Config.Legitbot.Tracers.Width = v end})
LegitVisualLeft:AddSlider('LegitbotTracerBrightness', {Text = 'Tracer Bright', Min = 1, Max = 10, Default = 5, Callback = function(v) Config.Legitbot.Tracers.Brightness = v end})
