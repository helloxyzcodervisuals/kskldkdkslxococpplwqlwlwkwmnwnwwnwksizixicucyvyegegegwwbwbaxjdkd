...
function Library:Resizify(Parent)
    ...
    if isMobile then
        Resizing.TouchLongPress:Connect(function()
            IsResizing = true
            InputLost = InputService:GetTouchLocation(InputService:GetTouches()[1])
            Size = Parent.Size
        end)
    else
        Resizing.InputBegan:Connect(handleResize)
    end
    ...
    if isMobile then
        InputService.TouchEnded:Connect(handleResizeEnd)
    else
        Resizing.InputEnded:Connect(handleResizeEnd)
    end
...
function Library:Hovering(Object)
    if type(Object) == "table" then 
        ...
        local mousePos
        if isMobile and #InputService:GetTouches() > 0 then
            mousePos = InputService:GetTouchLocation(InputService:GetTouches()[1])
        else
...
function Library:Draggify(Parent)
    ...
    local function handleDragStart(input)
        if input.UserInputType == Enum.UserInputType.Touch or input.UserInputType == Enum.UserInputType.MouseButton1 then
            ...
            Dragging = true
            Library.ActiveDraggable = Parent
    ...
    local function handleDragEnd(input)
        if input.UserInputType == Enum.UserInputType.Touch or input.UserInputType == Enum.UserInputType.MouseButton1 then
            if input.UserInputType == Enum.UserInputType.Touch and touchId ~= input then
                return
            end
            Dragging = false
            Library.ActiveDraggable = nil
            touchId = nil
        end
    end
    ...
    if isMobile then
        ...
        Parent.InputBegan:Connect(handleDragStart)
        Parent.InputEnded:Connect(handleDragEnd)
    end
...
function Library:Keypicker(properties) 
    ...
    local Items = Cfg.Items; do 
        Items.ColorpickerObject = Library:Create( "TextButton" , {
            ...
            BorderColor3 = rgb(0, 0, 0);
            Size = dim2(0, isMobile and 36 or 24, 0, isMobile and 16 or 11);
            BorderSizePixel = 0;
        ...
        Items.Colorpicker = Library:Create( "TextButton" , {
            ...
            Visible = false;
            BorderColor3 = rgb(0, 0, 0);
            Size = dim2(0, isMobile and 250 or 214, 0, isMobile and 230 or 210);
            BorderSizePixel = 0;
            BackgroundColor3 = themes.preset.inline
        ...
        Items.Fade = Library:Create( "Frame" , {
            ...
            Position = dim2(0, 1, 0, isMobile and 28 or 23);
            Size = dim2(1, -2, 1, -(isMobile and 29 or 24));
            ZIndex = 100;
            BorderSizePixel = 0;
        ...
        Items.SatValHolder = Library:Create( "Frame" , {
            ...
            Parent = Items.ColorTab;
            BorderColor3 = rgb(0, 0, 0);
            Size = dim2(1, -(isMobile and 46 or 36), 1, -(isMobile and 51 or 41));
            BorderSizePixel = 0;
        ...
        Items.SatValPicker = Library:Create( "Frame" , {
            ...
            Parent = Items.Color;
            BorderColor3 = rgb(0, 0, 0);
            Size = dim2(0, isMobile and 6 or 3, 0, isMobile and 6 or 3);
            BorderSizePixel = 0;
            ZIndex = 3;
        ...
        Items.AlphaInputFrame = Library:Create( "Frame" , {
            ...
            BorderColor3 = rgb(0, 0, 0);
            Size = dim2(1, -(isMobile and 46 or 36), 0, isMobile and 22 or 18);
            BorderSizePixel = 0;
            BackgroundColor3 = themes.preset.outline
        ...
        Items.RGBTextBox = Library:Create( "Frame" , {
            ...
            Parent = Items.ColorTab;
            Name = "\0";
            Position = dim2(0, 0, 1, -(isMobile and 24 or 20));
            BorderColor3 = rgb(0, 0, 0);
            Size = dim2(1, -(isMobile and 46 or 36), 0, isMobile and 22 or 18);
            BorderSizePixel = 0;
            BackgroundColor3 = themes.preset.outline
        ...
        Items.AlphaSlider = Library:Create( "TextButton" , {
            ...
            BorderColor3 = rgb(0, 0, 0);
            Size = dim2(0, isMobile and 20 or 16, 1, 0);
            BorderSizePixel = 0;
            BackgroundColor3 = themes.preset.outline
        ...
        Items.AlphaPicker = Library:Create( "Frame" , {
            ...
            BorderColor3 = rgb(0, 0, 0);
            Size = dim2(1, 2, 0, isMobile and 6 or 3);
            Position = dim2(0, -1, 0, -1);
            BackgroundColor3 = rgb(255, 255, 255)
        });
        ...
        Items.HueSlider = Library:Create( "TextButton" , {
            ...
            AutoButtonColor = false;
            Name = "\0";
            Position = dim2(1, -(isMobile and 22 or 18), 1, 0);
            BorderColor3 = rgb(0, 0, 0);
            Size = dim2(0, isMobile and 20 or 16, 1, 0);
            BorderSizePixel = 0;
            BackgroundColor3 = themes.preset.outline
        ...
        Items.TabButtons = Library:Create( "Frame" , {
            ...
            BorderColor3 = rgb(0, 0, 0);
            Size = dim2(1, 0, 0, isMobile and 28 or 23);
            BorderSizePixel = 0;
            BackgroundColor3 = rgb(255, 255, 255)
        });
        ...
        Library:Create( "UIPadding" , {
            Parent = Items.Buttons;
            PaddingTop = dim(0, isMobile and 5 or 3)
        });
    ...
    function Cfg.SetVisible(bool)
        ...
        Items.Colorpicker.Position = dim2(0, Items.ColorpickerObject.AbsolutePosition.X + 2, 0, Items.ColorpickerObject.AbsolutePosition.Y + (isMobile and 80 or 74))
    end
    ...
    if isMobile then
        Items.ColorpickerObject.TouchTap:Connect(function()
            Cfg.Open = not Cfg.Open
            Cfg.SetVisible(Cfg.Open)
        end)
    end
    ...
    Items.AlphaSlider.MouseButton1Down:Connect(function()
        if Library.ActiveDraggable then return end
        DraggingAlpha = true 
    end)
    ...
    if isMobile then
        Items.AlphaSlider.TouchTap:Connect(function()
            if Library.ActiveDraggable then return end
            DraggingAlpha = true 
        end)
        
        Items.HueSlider.TouchTap:Connect(function()
            if Library.ActiveDraggable then return end
            DraggingHue = true 
        end)
        
        Items.Sat.TouchTap:Connect(function()
            if Library.ActiveDraggable then return end
            DraggingSat = true  
        end)
    end
...
function Library:Window(properties)
    local Cfg = {
        ...
        Size = properties.Size or dim2(0, isMobile and 500 or 455, 0, isMobile and 650 or 605),
        TabInfo,
        Items = {},
    }
    ...
    local Items = Cfg.Items; do
        ...
        Items.Gradient = Library:Create( "Frame" , {
            ...
            Position = dim2(0, 1, 0, 1),
            BorderColor3 = rgb(0, 0, 0),
            Size = dim2(1, -2, 0, isMobile and 20 or 16),
            BorderSizePixel = 0,
            BackgroundColor3 = rgb(255, 255, 255)
        });
        ...
        Items.Inline = Library:Create( "Frame" , {
            Parent = Items.Inline,
            Name = "\0",
            Position = dim2(0, 5, 0, isMobile and 22 or 18),
            BorderColor3 = rgb(0, 0, 0),
            Size = dim2(1, -10, 1, -(isMobile and 27 or 23)),
            BorderSizePixel = 0,
            BackgroundColor3 = themes.preset.inline
        });	Library:Themify(Items.Inline, "inline", "BackgroundColor3")
        ...
        Items.TabButtons = Library:Create( "Frame" , {
            ...
            Position = dim2(0, 1, 0, 1),
            BorderColor3 = rgb(0, 0, 0),
            Size = dim2(1, -2, 0, isMobile and 28 or 23),
            BorderSizePixel = 0,
            BackgroundColor3 = rgb(255, 255, 255)
        });
        ...
        Items.PageHolder = Library:Create( "Frame" , {
            Parent = Items.PageHolder,
            Name = "\0",
            Position = dim2(0, 1, 0, isMobile and 29 or 24),
            BorderColor3 = rgb(0, 0, 0),
            Size = dim2(1, -2, 1, -(isMobile and 30 or 25)),
            BorderSizePixel = 0,
            BackgroundColor3 = themes.preset.background
        ...
        Library:Create( "UIListLayout" , {
            Parent = Items.Elements,
            Padding = dim(0, isMobile and 6 or 3),
            SortOrder = Enum.SortOrder.LayoutOrder
        });
...
function Library:PlayerList(properties)
    ...
    function Cfg.AddPlayer(player)
        ...
        if isMobile then
            SeperateData.Background.TouchTap:Connect(function()
                if SeperateData.Priority.Text == "LocalPlayer" then 
                    return
                end 
    ...
    if isMobile then
        Items.Refresh.TouchTap:Connect(function()
            for _,player in Players:GetPlayers() do
                if player == Players.LocalPlayer then 
                    continue 
                end 
...
function Library:MultiSection(properties)
    ...
    Items.Fade = Library:Create( "Frame" , {
        Parent = Items.Inline,
        Size = dim2(1, 0, 1, -(isMobile and 28 or 24)),
        Name = "\0",
        Position = dim2(0, 0, 0, isMobile and 28 or 24),
        BorderColor3 = rgb(0, 0, 0),
        BorderSizePixel = 0,
        ZIndex = 2,
        BackgroundTransparency = 1,
    ...
    Items.Elements = Library:Create( "Frame" , {
        ...
        Visible = true,
        BackgroundTransparency = 1,
        Position = dim2(0, 6, 0, isMobile and 30 or 26),
        Size = dim2(1, 12, 0, 0),
        BorderSizePixel = 0,
        AutomaticSize = Enum.AutomaticSize.Y,
        BackgroundColor3 = rgb(255, 255, 255)
    ...
    Library:Create( "UIListLayout" , {
        Parent = Items.Elements,
        Padding = dim(0, isMobile and 6 or 4),
        SortOrder = Enum.SortOrder.LayoutOrder
    });
    ...
    Items.ScrollingFrame = Library:Create( "ScrollingFrame" , {
        ...
        Parent = Items.Inline,
        Size = dim2(1, -3, 1, -(isMobile and 25 or 21)),
        TopImage = "rbxassetid://118750478739322",
        Position = dim2(0, 0, 0, isMobile and 27 or 23),
        BottomImage = "rbxassetid://74268315755026",
        BackgroundTransparency = 1,
        BackgroundColor3 = rgb(255, 255, 255)
    ...
    Items.ScrollingLine = Library:Create( "Frame" , {
        ...
        AnchorPoint = vec2(1, 0),
        Name = "\0",
        Position = dim2(1, -2, 0, isMobile and 26 or 22),
        Parent = Items.Inline,
        Size = dim2(0, 4, 1, -(isMobile and 22 or 18)),
        BorderSizePixel = 0,
        BackgroundColor3 = themes.preset.outline
    ...
    Items.Elements:GetPropertyChangedSignal("AbsoluteSize"):Connect(function()
        if Items.ScrollingFrame.AbsoluteSize.Y < Items.Elements.AbsoluteSize.Y then 
            ...
            Library:Tween(Items.ScrollingFrame, {ScrollBarThickness = isMobile and 4 or 2})
...
for _,tab in Cfg.Tabs do 
    ...
    if isMobile then
        SubItems.Button.TouchTap:Connect(function()
            Data.OpenTab()
        end)
    end
...
function Library:Section(properties)
    ...
    local Items = Cfg.Items; do
        ...
        Items.Elements = Library:Create( "Frame" , {
            ...
            Name = "\0",
            BackgroundTransparency = 1,
            Position = dim2(0, 6, 0, isMobile and 24 or 20),
            Size = dim2(1, -12, 0, 0),
            BorderSizePixel = 0,
            AutomaticSize = Enum.AutomaticSize.Y,
            BackgroundColor3 = rgb(255, 255, 255)
        ...
        if Cfg.Size then 
            Items.ScrollingFrame = Library:Create( "ScrollingFrame" , {
                ...
                ScrollBarThickness = 0,
                Parent = Items.Inline,
                Size = dim2(1, -3, 1, -(isMobile and 27 or 23)),
                TopImage = "rbxassetid://118750478739322",
                Position = dim2(0, 0, 0, isMobile and 24 or 20),
                BottomImage = "rbxassetid://74268315755026",
                BackgroundTransparency = 1,
                BackgroundColor3 = rgb(255, 255, 255)
            });	Library:Themify(Items.ScrollingFrame, "accent", "ScrollBarImageColor3")
            ...
            Items.ScrollingLine = Library:Create( "Frame" , {
                ...
                AnchorPoint = vec2(1, 0),
                Name = "\0",
                Position = dim2(1, -2, 0, isMobile and 23 or 19),
                Parent = Items.Inline,
                Size = dim2(0, 4, 1, -(isMobile and 25 or 21)),
                BorderSizePixel = 0,
                BackgroundColor3 = themes.preset.outline
            });	Library:Themify(Items.ScrollingLine, "outline", "BackgroundColor3")
...
function Library:Toggle(properties) 
    ...
    local Items = Cfg.Items; do 
        Items.Object = Library:Create( "TextButton" , {
            ...
            BackgroundTransparency = 1,
            Name = "\0",
            Size = dim2(1, 0, 0, isMobile and 15 or 11),
            BorderSizePixel = 0,
            TextSize = 14,
            BackgroundColor3 = rgb(255, 255, 255)
        });
        ...
        Items.Outline = Library:Create( "Frame" , {
            ...
            Parent = Items.Object,
            BorderColor3 = rgb(0, 0, 0),
            Size = dim2(0, isMobile and 15 or 11, 0, isMobile and 15 or 11),
            BorderSizePixel = 0,
            BackgroundColor3 = themes.preset.outline
        });	Library:Themify(Items.Outline, "outline", "BackgroundColor3")
        ...
        Items.Name = Library:Create( "TextLabel" , {
            ...
            Name = "\0",
            BackgroundTransparency = 1,
            Position = dim2(0, isMobile and 20 or 15, 0, -2),
            BorderSizePixel = 0,
            AutomaticSize = Enum.AutomaticSize.XY,
            TextSize = isMobile and 14 or 12,
            BackgroundColor3 = rgb(255, 255, 255)
        ...
        if Cfg.Folding then 
            Items.ArrowHolder = Library:Create( "Frame" , {
                ...
                Name = "\0",
                BorderColor3 = rgb(0, 0, 0),
                Size = dim2(0, isMobile and 10 or 7, 0, isMobile and 10 or 7),
                BorderSizePixel = 0,
                BackgroundColor3 = rgb(255, 255, 255)
            });
            ...
            Items.Arrow = Library:Create( "ImageLabel" , {
                ...
                BackgroundTransparency = 1,
                Size = dim2(0, isMobile and 10 or 7, 1, isMobile and 10 or 7),
    ...
    if isMobile then
        Items.Object.TouchTap:Connect(function()
            Cfg.Enabled = not Cfg.Enabled
            Cfg.Set(Cfg.Enabled)
        end)
    end
...
function Library:Slider(properties) 
    ...
    local Items = Cfg.Items; do
        Items.Slider = Library:Create( "TextButton" , {
            ...
            BackgroundTransparency = 1,
            Name = "\0",
            Size = dim2(1, 0, 0, isMobile and 30 or 25),
            BorderSizePixel = 0,
            TextSize = 14,
            BackgroundColor3 = rgb(255, 255, 255)
        });
        ...
        Items.Outline = Library:Create( "TextButton" , {
            ...
            AutoButtonColor = false,
            Name = "\0",
            Position = dim2(0, 0, 0, isMobile and 18 or 14),
            BorderColor3 = rgb(0, 0, 0),
            Size = dim2(1, 0, 0, isMobile and 15 or 11),
            BorderSizePixel = 0,
            BackgroundColor3 = themes.preset.outline
        ...
        Items.Components = Library:Create( "Frame" , {
            ...
            BorderColor3 = rgb(0, 0, 0),
            Size = dim2(0, 0, 0, isMobile and 15 or 11),
            BorderSizePixel = 0,
            BackgroundColor3 = rgb(255, 255, 255)
        });
        ...
        Items.Minus = Library:Create( "ImageButton" , {
            ...
            BackgroundTransparency = 1,
            Name = "\0",
            Size = dim2(0, isMobile and 10 or 7, 1, 0),
            BorderSizePixel = 0,
            BackgroundColor3 = rgb(255, 255, 255)
        });
    ...
    if isMobile then
        Items.Minus.TouchTap:Connect(function()
            Cfg.Value -= Cfg.Intervals
            Cfg.Set(Cfg.Value)
        end)
    end
    ...
    if isMobile then
        Items.Plus.TouchTap:Connect(function()
            Cfg.Value += Cfg.Intervals
            Cfg.Set(Cfg.Value)
        end)
    end
...
function Library:Dropdown(properties) 
    ...
    local Items = Cfg.Items; do 
        Items.Dropdown = Library:Create( "TextButton" , {
            ...
            BackgroundTransparency = 1,
            Name = "\0",
            Size = dim2(1, 0, 0, isMobile and 38 or 32),
            BorderSizePixel = 0,
            TextSize = 14,
            BackgroundColor3 = rgb(255, 255, 255)
        });
        ...
        Items.Outline = Library:Create( "TextButton" , {
            ...
            Position = dim2(0, 0, 0, isMobile and 18 or 14),
            BorderColor3 = rgb(0, 0, 0),
            Size = dim2(1, 0, 0, isMobile and 22 or 18),
            BorderSizePixel = 0,
            BackgroundColor3 = themes.preset.outline
        });	Library:Themify(Items.Outline, "outline", "BackgroundColor3")
    ...
    function Cfg.SetVisible(bool)
        ...
        Items.DropdownElements.Position = dim2(0, Items.Outline.AbsolutePosition.X, 0, Items.Outline.AbsolutePosition.Y + (isMobile and 85 or 80))
...
function Library:Keybind(properties) 
    ...
    local Items = Cfg.Items; do 
        Items.KeybindOutline = Library:Create( "TextButton" , {
            ...
            Text = "",
            Name = "\0",
            Size = dim2(0, isMobile and 15 or 10, 0, isMobile and 15 or 11),
            BorderColor3 = rgb(0, 0, 0),
            BorderSizePixel = 0,
            AutomaticSize = Enum.AutomaticSize.X,
            BackgroundColor3 = themes.preset.inline
        ...
        Items.ModeHolder = Library:Create( "Frame" , {
            Parent = Library.Items,
            Size = dim2(0, isMobile and 180 or 150, 0, isMobile and 50 or 44),
            Name = "\0",
            BorderColor3 = rgb(0, 0, 0),
            BorderSizePixel = 0,
            AutomaticSize = Enum.AutomaticSize.XY,
    ...
    function Cfg.SetVisible(bool)
        ...
        Items.ModeHolder.Position = dim2(0, Items.KeybindOutline.AbsolutePosition.X + 2, 0, Items.KeybindOutline.AbsolutePosition.Y + (isMobile and 80 or 74))
    end
    ...
    if isMobile then
        Items.KeybindOutline.TouchTap:Connect(function()
            task.wait()
            Items.Key.Text = "..."	
    ...
    if isMobile then
        ...
        Items.KeybindOutline.TouchLongPress:Connect(function()
            touchHold = true
            task.wait(0.5)
            if touchHold then
                Cfg.Open = not Cfg.Open 
...
function Notifications:Create(properties)
    ...
    local Items = Cfg.Items; do 
        Items.Outline = Library:Create( "Frame" , {
            Parent = Library.Items,
            Size = dim2(0, 0, 0, isMobile and 22 or 18),
            Name = "\0",
            AnchorPoint = vec2(1, 0),
